...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [7] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ink, 1),
  [9] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [11] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_ink_repeat1, 2),
  [13] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ink_repeat1, 2), SHIFT_REPEAT(3),
